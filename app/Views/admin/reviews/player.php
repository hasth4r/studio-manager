        ...
        <div class="flex-1 flex flex-col bg-black relative group">
            ...
            <div class="media-container flex-1 flex items-center justify-center relative">
                ...
                <?php if($review->file_type === 'video'): ?>
                    <video id="mediaElement" class="w-full h-full object-contain" disablePictureInPicture controlsList="nodownload">
                        <source src="<?= base_url('media/serve/' . esc($review->proxy_path)) ?>" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                <?php else: ?>
                    <img id="mediaElement" src="<?= base_url('media/serve/' . esc($review->proxy_path)) ?>" class="w-full h-full object-contain">
                <?php endif; ?>
